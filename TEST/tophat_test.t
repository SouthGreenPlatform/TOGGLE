...
my @expectedOutput=("$testingDir/accepted_hits.bam","$testingDir/insertions.bed","$testingDir/prep_reads.info","$testingDir/referenceRNASeq.2.bt2","$testingDir/referenceRNASeq.3.ebwt","$testingDir/referenceRNASeq.fa","$testingDir/referenceRNASeq.rev.1.ebwt","$testingDir/RNASeq_1.fastq","$testingDir/align_summary.txt","$testingDir/junctions.bed","$testingDir/referenceRNASeq.1.bt2","$testingDir/referenceRNASeq.2.ebwt","$testingDir/referenceRNASeq.4.bt2","$testingDir/referenceRNASeq.gff3","$testingDir/referenceRNASeq.rev.2.bt2","$testingDir/RNASeq_2.fastq","$testingDir/deletions.bed","$testingDir/logs","$testingDir/referenceRNASeq.1.ebwt","$testingDir/referenceRNASeq.3.bt2","$testingDir/referenceRNASeq.4.ebwt","$testingDir/referenceRNASeq.rev.1.bt2","$testingDir/referenceRNASeq.rev.2.ebwt","$testingDir/unmapped.bam");
