...
# data
my $dataFastqpairedTwoIndividusGzippedIrigin = "$toggle/data/testData/fastq/pairedTwoIndividusGzippedIrigin";
...
my $testingDir="$toggle/dataTest/pairedTwoIndividusGzippedIrigin-noSGE";
my $cleaningCmd="rm -Rf $testingDir";
system ($cleaningCmd) and die ("ERROR: $0 : Cannot remove the previous test directory with the command $cleaningCmd \n$!\n");


my $runCmd = "toggleGenerator.pl -c ".$fileSNPPairedNoSGE." -d ".$dataFastqpairedTwoIndividusGzippedIrigin." -r ".$dataRefIrigin." -o ".$testingDir;
