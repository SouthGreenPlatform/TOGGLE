...
# data
my $dataFastqsingleTwoIndividuIrigin = "$toggle/data/testData/fastq/singleTwoIndividuIrigin";

# Remove files and directory created by previous test
my $testingDir="$toggle/dataTest/singleTwoIndividuIrigin-noSGE";
my $cleaningCmd="rm -Rf $testingDir";
system ($cleaningCmd) and die ("ERROR: $0 : Cannot remove the previous test directory with the command $cleaningCmd \n$!\n");

my $runCmd = "toggleGenerator.pl -c ".$fileSNPSingleNoSGE." -d ".$dataFastqsingleTwoIndividuIrigin." -r ".$dataRefIrigin." -o ".$testingDir;
...
my $expectedOutput="2179526	467	.	T	C	64.17	FILTER-DP	AC=2;AF=1.00;AN=2;DP=2;ExcessHet=3.0103;FS=0.000;MLEAC=2;MLEAF=1.00;MQ=37.00;QD=32.08;SOR=0.693	GT:AD:DP:GQ:PL	1/1:0,2:2:6:90,6,0	./.";
