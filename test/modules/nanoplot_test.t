...
is(nanoplot::nanoplot($fileIn,$dirOut,$optionHachees),1,'nanoplot::nanoplot  - Test for nanoplot running');

# expected output test
my $observedOutput = `ls nanopore-100-reads-fastq/*.html`;
my @observedOutput = split /\n/,$observedOutput;
my @expectedOutput = ('nanopore-100-reads-fastq/NanoPlot-report.html');
...
is($observedMD5sum, $expectedMD5sum, "nanoplot::nanoplot NanoStats content");
