...
# input file
my $fileIn = "$toggle/data/testData/phylip/alignment.READSEQ.phylip";
my $fileOut = "alignment.FASTME";
...
#execution test
is(fastme::fastme($fileIn, $fileOut,$optionHachees),1,'fastme::fastme');


# expected output test
my $observedOutput = `ls $fileOut.nwk`;
my @observedOutput = split /\n/,$observedOutput;
my @expectedOutput = ("$fileOut.nwk");

is_deeply(\@observedOutput,\@expectedOutput,'fastme::execution Single - output list');


# expected content test
my $observedContent=`wc -l $fileOut.nwk`;
my $validContent = ( $observedContent =~ m/2/);
is($validContent,1,'fastme::fastme - output content');
