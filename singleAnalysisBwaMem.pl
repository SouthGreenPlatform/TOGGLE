...
#$softParameters = toolbox::extractHashSoft($optionref,"BWA mem");                                           # recovery of specific parameters of bwa aln
...
my $samFileOut = "$newDir"."/"."$fileWithoutExtention".".BWAMEM.sam";                                     # name for the output file of bwa samse
$softParameters = toolbox::extractHashSoft($optionref,"BWA mem");                                         # recovery of specific parameters of bwa samse
...
bwa::bwaMem($samFileOut,$refFastaFile,$listOfFiles[0],undef,$fileWithoutExtention,$softParameters);            # generate alignement in SAM format
